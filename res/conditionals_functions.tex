...
if (<betingelse>):
	...
	\column{.2\textwidth}
	\centering
	\includegraphics[width=0.5\textwidth]{jigsaw-if.png}
	
	\includegraphics[width=0.5\textwidth]{jigsaw-elif.png}
	
	\includegraphics[width=0.5\textwidth]{jigsaw-else.png}
	
	\column{.2\textwidth}
	\centering
	
	\includegraphics[width=0.5\textwidth]{jigsaw-example.png}
